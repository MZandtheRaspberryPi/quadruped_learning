...
SIM_MOTOR_IDS = [FRONT_RIGHT_HIP_ID,
                  FRONT_RIGHT_KNEE_ID,  BACK_RIGHT_HIP_ID, BACK_RIGHT_KNEE_ID,
                  FRONT_LEFT_HIP_ID, FRONT_LEFT_KNEE_ID,
                  BACK_LEFT_HIP_ID, BACK_LEFT_KNEE_ID]
LOWER_MOTOR_LIMIT = -np.pi
UPPER_MOTOR_LIMIT = np.pi
